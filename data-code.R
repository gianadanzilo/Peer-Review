...
#load HCRIS dataset from 2009-2019
dat.2009 <- read_csv("hmwk_data/data-2009.csv")
dat.2010 <- read_csv("hmwk_data/data-2010.csv")
dat.2011 <- read_csv("hmwk_data/data-2011.csv")
dat.2012 <- read_csv("hmwk_data/data-2012.csv")
dat.2013 <- read_csv("hmwk_data/data-2013.csv")
...
na.full <- rbind(dat.2009, dat.2010, dat.2011, dat.2012, dat.2013, dat.2014, dat.2015, dat.2016, dat.2017, dat.2018, dat.2019)
str(na.full)

write_csv(na.full, "hmwk_data/hcris_data_2009-2019.csv")
